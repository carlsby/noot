      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl max-w-md w-full mx-4 border border-slate-200 dark:border-slate-700">
        <div className="p-6">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-2">Bekräfta rensning</h3>
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              onClick={onConfirm}
              className="flex-1 px-4 py-3 rounded-xl bg-yellow-600 text-white hover:bg-yellow-700 font-medium transition-colors shadow-sm"
            >
              Rensa
            </button>
          </div>

...
export default function AddCategoryForm({ addCategory }) {
  ...
  return (
    ...
    >
      ...
      />
      <button
        className={`p-2  text-black transition-colors shadow-sm ${newCategoryName.trim() === "" ? "bg-neutral-300 dark:bg-neutral-900 space:bg-green-700 cursor-not-allowed" : "bg-neutral-300 hover:bg-neutral-300/80 space:bg-green-950 space:text-white"}`}

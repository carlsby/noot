...
export default function SidebarFooter({ addCategory }) {
  ...
  return (
    <div className="h-[95px] border-t flex items-center justify-center px-8 border-neutral-200 dark:border-neutral-700">
      <div
      ...
      >
        <div className="flex-shrink-0">
          <NotepadText
            size={16}
            className="text-neutral-400 space:text-indigo-950"
          />
        </div>
        <input
          type="text"
        ...
        />
        <button
          className={`p-2 rounded-md text-black transition-colors shadow-sm ${
            newCategoryName.trim() === ""
              ? "bg-neutral-300 dark:bg-neutral-900 space:bg-green-700 cursor-not-allowed"
              : "bg-neutral-300 hover:bg-neutral-300/80 space:bg-green-950 space:text-white"
          }`}
